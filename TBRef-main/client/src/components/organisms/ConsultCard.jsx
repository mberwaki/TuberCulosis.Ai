            ...
            <div className="card mr-3 mt-3 pb-5">
              ...
              <div className="row mt-4 ml-4 mb-0 pb-0">
                ...
                <div className="col-4 text-left mt-2">
                  <div className="row">
                    <p className="firstCardText">Dr. Y Diagnosis</p>
                  </div>
                  <div className="row secondCardText">
                    <p className="col-12 px-0">
                      {this.props.results.TBRef.doctorDiagnosis.condition}
                    </p>
                    <div className="text-muted h6 col-12 px-0">
                      {Math.round(
                        parseFloat(
                          this.props.results.TBRef.doctorDiagnosis.confidence
                        )
                      )}
                      % confidence
                    </div>
                  ...
                  <div style={{ transform: "scale(0.8)", marginLeft: "-30px" }}>
                    <div className="row pt-3">
                      <p className="text-muted h6">TBRef AI Prediction:</p>
                    </div>
                    <div className="row color-purple h4">
                      <p className="col-12 px-0">
                        {this.props.results.TBRef.aiDiagnosis.condition}
                      </p>
                      <div className="text-muted h6 col-12 px-0">
                        {Math.round(
                          parseFloat(
                ...
                <div className="col-4 px-4 border-left text-center">
                  <div className="m-0">
                    <div className="text-center">
                      <p className="firstCardText text-center mr-2">
                        Diagnosed By
                      </p>
                    </div>
                    <div
                    ...
                    <div className="text-center">
                      ...
                      <div className="btn btn-primary btn-sm mx-auto px-4">
                        Contact
                      </div>
                    </div>
                  </div>
